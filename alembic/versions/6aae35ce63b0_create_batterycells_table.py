...
def upgrade():
    op.create_table('batteryCells',
                    sa.Column('id', sa.Integer(), nullable=False,
                              primary_key=True),
                    sa.Column('cellNameId', sa.String(), nullable=False),
                    ...
                    sa.Column('capacityAh', sa.Float(), nullable=False),
                    ...
                    sa.Column('temperatureC', sa.Float(), nullable=False),
                    sa.Column('maxStateOfCharge', sa.Float(), nullable=False),
                    sa.Column('minStateOfCharge', sa.Float(), nullable=False),
                    sa.Column('depthOfDischarge', sa.Float(), nullable=False),
                    sa.Column('chargeCapacityRate',
                              sa.Float(), nullable=False),
                    sa.Column('dischargeCapacityRate',
                              sa.Float(), nullable=False),
