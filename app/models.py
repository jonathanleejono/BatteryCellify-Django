...
batteryCells = Table(
    ...
    Column("cycles", Integer, nullable=False),
    ...
    Column("capacityAh", Integer, nullable=False),
    ...
    Column("temperatureC", Integer, nullable=False),
    Column("maxStateOfCharge", Integer, nullable=False),
    Column("minStateOfCharge", Integer, nullable=False),
    Column("depthOfDischarge", Integer, nullable=False),
    Column("chargeCapacityRate", Integer, nullable=False),
    Column("dischargeCapacityRate", Integer, nullable=False),
    Column("created_at", TIMESTAMP(
        timezone=True), nullable=False, server_default=text('now()')),
